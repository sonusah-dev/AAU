      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form class="needs-validation" action="scripts/create/create_events.php" method="POST" novalidate>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="organized_by" class="form-control" id="validationCustom02" required />
                  <div class="valid-feedback">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="date" name="starting_date" class="form-control" id="validationCustom03" required />
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="date" name="ending_date" class="form-control" id="validationCustom03" required />
                  <div class="invalid-feedback">
                    Please provide a valid date.
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="sponsored_by" class="form-control" id="validationCustom03" required />
                  <div class="invalid-feedback">
                    Please provide a valid info.
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="venue" class="form-control" id="validationCustom04" required />
                  <div class="invalid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="level" class="form-control" id="validationCustom03" required />
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="number" name="event_year" class="form-control" id="validationCustom04" required />
                  <div class="invalid-feedback">
                    Please provide a valid date.
                  </div>
                </div>
