...
if (isset($_POST['update'])) {
  ...
  if (mysqli_query($conn, $query)) {
    ...
    header('location:showstudents.php?fail=ok');
  }
}
?>
<!DOCTYPE html>
        ...
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form class="needs-validation" method="POST">
              <?php
              $id = $_GET['id'];
              $row = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM students WHERE id = $id"));
              ?>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="date" class="form-control" id="validationCustom02" name="dob" value="<?php echo $row['dob'] ?>" required />
                  <div class="valid-feedback">
              ...
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <select name="department" id="validationCustom04" class="form-control" required>
                    <option value="<?php echo $row['department'] ?>">SELECT</option>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom06" name="address" value="<?php echo $row['address'] ?>" required />
                  <div class="invalid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-3 mb-3">
                  ...
                  <input type="number" class="form-control" id="validationCustom04" name="registration" value="<?php echo $row['registration_no'] ?>" required />
                  <div class="invalid-feedback">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="addmission_year" value="<?php echo $row['addmission_year'] ?>" required="" />
                  <div class="invalid-feedback">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom06" name="degree" value="<?php echo $row['degree'] ?>" required />
                  <div class="invalid-feedback">
                    Please provide a valid date.
                  </div>
                </div>
