  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            <h4 class="header-title">Add Welfare Activity</h4>
            <form class="needs-validation" action="scripts/create/create_welfare_activity.php" method="POST" novalidate>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="date" class="form-control" id="validationCustom03" name="activity_year" required />
