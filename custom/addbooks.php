      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form class="needs-validation" action="scripts/create/create_books.php" method="POST" novalidate>
              <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom02" name="book_type" required />
                  <div class="valid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control" id="validationCustom04" name="quantity" required />
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="date" class="form-control" id="validationCustom03" name="procurement_year" required />
                  <div class="invalid-feedback">
