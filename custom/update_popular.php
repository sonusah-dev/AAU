...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE  popular_publication SET 
        title = '$title',
        author = '$author',
  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            <h4 class="header-title">Add popular in session</h4>
            <form class="needs-validation" method="POST">
              <?php
              $id = $_GET['id'];
              $row = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM popular_publication WHERE id = $id"))
              ?>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  <label for="validationCustom03">Publication Year</label>
                  <input type="text" class="form-control" id="validationCustom03" name="publication_year" value="<?php echo $row['publication_year'] ?>" required />
