  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            <h4 class="header-title">Add Placements</h4>
            <form class="needs-validation" action="scripts/create/create_placement.php" method="POST" novalidate>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom02" name="placement_year" required />
                  <div class="valid-feedback">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="package" required />
              ...
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="period" required />
                  <div class="invalid-feedback">
                    Please provide a valid detail.
                  </div>
                </div>
