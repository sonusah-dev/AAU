      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form class="needs-validation" action="scripts/create/create_faculty.php" method="POST" novalidate>
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationCustomUsername" name="address" required />
              ...
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="qualification" required />
                  <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom04" name="specialization" required />
                  <div class="invalid-feedback">
