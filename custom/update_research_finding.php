...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE  salient_research SET 
        activity = '$activity',
  ...
  if (mysqli_query($conn, $query)) {
    ...
    header('location:showresearchfindingdetails.php?fail=ok');
  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            <h4 class="header-title">Add research finding</h4>
            <form class="needs-validation" method="POST">
              <?php
              $id = $_GET['id'];
              $row = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM salient_research"));
              ?>
              <div class="form-row">
