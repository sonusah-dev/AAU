      ...
      <div class="main-content-inner">
        <div class="row">
          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                <h4 class="header-title">Books Details</h4>
                            ...
                            <?php if ($_SESSION['user_type'] == 0) : ?>
                              <td>
                                <ul class="d-flex justify-content-center">
                                  <li class="mr-3">
                                    <a href="update_books.php?id=<?php echo $row['id']; ?>" class="text-primary"><i class="fa fa-edit"></i></a>
                                  </li>
                                  <li>
                                    <a href="scripts/delete/delete_books.php?id=<?php echo $row['id']; ?>" class="text-danger"><i class="ti-trash"></i></a>
                                  </li>
                                </ul>
                              </td>
                            <?php endif ?>
