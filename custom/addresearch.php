      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form class="needs-validation" action="scripts/create/create_research.php" method="POST" novalidate="">
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom02" name="objective" required />
                  <div class="valid-feedback">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationCustom03" name="pi" required />
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="co_pi" required />
                  <div class="invalid-feedback">
                    Please provide a valid name.
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="project_details" required />
                  <div class="invalid-feedback">
                    Please provide a valid name.
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom06" name="funding_agency" required />
                  <div class="invalid-feedback">
                    Please provide a valid name.
                  </div>
                </div>
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="number" class="form-control" id="validationCustom03" name="project_amount" required />
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="project_period" required />
                  <div class="invalid-feedback">
                    Please provide a valid detail.
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="date" class="form-control" id="validationCustom06" placeholder="start_date" required />
                  <div class="invalid-feedback">
                    Please provide a valid detail.
                  </div>
                </div>
