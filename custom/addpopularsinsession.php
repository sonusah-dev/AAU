  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div class="col-12">
        <div class="card mt-5">
          <div class="card-body">
            <h4 class="header-title">Add Popular Publications</h4>
            <form class="needs-validation" action="scripts/create/create_popular.php" method="POST" novalidate="">
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationCustom03" name="publication_year" required />
